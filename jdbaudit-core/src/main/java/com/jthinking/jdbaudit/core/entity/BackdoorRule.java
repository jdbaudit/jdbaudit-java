...
public class BackdoorRule {
    ...
    private List<BackdoorCondition> conditions;
    ...
    public List<BackdoorCondition> getConditions() {
        return conditions;
    }

    public void setConditions(List<BackdoorCondition> conditions) {
