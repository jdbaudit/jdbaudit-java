 ...
 * @author Jia Bochao
 */
public class CCSSCalculator {

    public static Severity getSeverity(CCSSVector vector) {
    ...
    public static String vectorString(CCSSVector ccssVector) {
        return vectorString(ccssVector.getAccessVector(), ccssVector.getAccessComplexity(), ccssVector.getAuthentication(),
                ccssVector.getConfidentialityImpact(), ccssVector.getIntegrityImpact(), ccssVector.getAvailabilityImpact(),
                ccssVector.getPrivilegeLevel(), ccssVector.getExploitabilityMethod());
    }
    ...
    public static String vectorString(AccessVector accessVectorEnum,
                                      ...
                                      ExploitabilityMethod exploitabilityMethod) {
        return String.format("AV:%s/AC:%s/Au:%s/C:%s/I:%s/A:%s/PL:%s/EM:%s",
                ...
                privilegeLevel.getShortName(),
                exploitabilityMethod.getShortName());
    }


    public static double baseScore(CCSSVector ccssVector) {
        return baseScore(ccssVector.getAccessVector(), ccssVector.getAccessComplexity(), ccssVector.getAuthentication(),
                ccssVector.getConfidentialityImpact(), ccssVector.getIntegrityImpact(), ccssVector.getAvailabilityImpact());
    }
